import CompliancePolicy from "@/components/homeowners/CompliancePolicy";
...
export default async function Page() {
  const data = await fetchDisclaimer("compliance-policy");

  return (
    <>
      <CompliancePolicy content={data?.content} />
    </>
  );
}
