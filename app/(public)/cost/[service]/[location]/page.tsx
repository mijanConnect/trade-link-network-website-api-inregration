			...
			<div className="bg-primary text-white">
				<div className="container mx-auto px-4 py-16 lg:py-24">
					...
					<h1 className="mt-3 text-3xl font-bold lg:text-6xl">
						{guideData.title || `${serviceName} in ${locationName}`}
					</h1>
						...
						<article id="cost-details" className="scroll-mt-24">
							<div className="mb-6 rounded-md border border-primary/20 bg-primary/10 p-4">
								<p className="text-[14px] font-medium text-primaryText">
									Cost guide for <span className="font-bold">{locationName}</span>
								</p>
							</div>
							...
							<section className="mb-8 mt-8">
								...
								<p className="mb-2 text-[18px] font-semibold text-primaryTextLight">
									{content?.averageCost || "No average cost information available."}
								</p>
							</section>
