      ...
      <div className="flex w-full max-w-lg flex-col gap-6 rounded-lg bg-white p-4 shadow-lg md:p-6">
        ...
        <div className="flex flex-col gap-2">
          ...
          {imagePreview ? (
            ...
            <label className="flex cursor-pointer flex-col items-center justify-center gap-3 rounded-lg border-2 border-dashed border-slate-300 bg-slate-50 p-6 transition hover:border-primary hover:bg-slate-100 disabled:cursor-not-allowed disabled:opacity-50">
