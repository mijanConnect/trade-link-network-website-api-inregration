...
import ShowProfileModalTrade from "../profile/ShowProfileModalTrade";
          ...
          <div className="flex items-center gap-2 sm:gap-3 lg:gap-4 ml-auto">
            {isLoggedIn && (
              <div className="flex gap-4">
                ...
                <div className="hidden lg:flex items-center gap-2 lg:gap-6">
                  <Link
                    href="/trade-person/my-responses"
                    className={`nav-link text-[14px] sm:text-[16px] font-bold text-primary transition-all ${
                      isActive("/trade-person/my-responses") ? "active" : ""
                    }`}
                    onClick={() => setOpen(false)}
                  >
                    My Responses
